...
extern u16      ad_xwonce(ADCn, ADC_Ch, ADC_nbit); //采集某路模拟量的AD值,加八次硬件平均滤波

extern u16      ad_mid    (ADCn, ADC_Ch, ADC_nbit);    //中值滤波后的结果
extern  u16     ad_xwmid(ADCn, ADC_Ch, ADC_nbit);   //八次平均滤波，然后中值滤波，

//u8  AD1_flag;
extern void      ad1_DSP_ave(ADCn ,ADC_Ch , ADC_nbit, u8 N);//DSP均值 20次

extern void ad1_XW_ave(ADCn adcn, ADC_Ch ch, ADC_nbit bit, u8 N);
...
extern void     adc_xwstart(ADCn, ADC_Ch, ADC_nbit);  //--添加硬件八次平均----
